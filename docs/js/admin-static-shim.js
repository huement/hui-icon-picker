...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (fixedHeaderToggle) {
    const header = document.querySelector('.wavedash-action-bar')
  ...
  function addRTLStyles() {
    ...
    style.textContent = `
      ...
      [dir="rtl"] .wavedash-action-bar,
      [dir="rtl"] .wavedash-content,
      ...
      [dir="rtl"] body:not(.toggled) .wavedash-main-wrapper,
      [dir="rtl"] body:not(.toggled) .wavedash-content {
        margin-left: 0 !important;
        margin-right: 280px !important;
      }

      /* Fix main content when sidebar is toggled/collapsed */
      [dir="rtl"] body.toggled .wavedash-main-wrapper,
      [dir="rtl"] body.toggled .wavedash-content {
        margin-left: 0 !important;
      ...
      [dir="rtl"] .wavedash-action-bar .dropdown-menu,
